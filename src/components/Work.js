...
const Work = () => (
  <section className="section" id="work">
    ...
    <div className="case-grid">
      ...
      <article className="case-card active-build-card"><div className="case-meta"><span>04</span><span className="active-label"><i className="status-dot" /> Active build</span></div><div><p className="case-kicker">Market Intelligence Lab</p><h3>Making complex market conditions easier to understand.</h3><p>An in-progress research platform that collects, validates, normalizes, and visualizes market evidence while the methodology for an intuitive, explainable market score is researched and tested.</p><Link className="case-link" to="/case-studies/market-intelligence-lab">Follow the case study <span>↗</span></Link></div><div className="tags"><span>Python</span><span>Data validation</span><span>Streamlit</span><span>Scoring research</span></div></article>
      <article className="case-card">
        <div className="case-meta"><span>05</span><span>Independent cloud project</span></div>
        <div><p className="case-kicker">Remembering Young Hoon</p><h3>A living archive built around trust and shared memories.</h3><p>Independently led a bilingual memorial archive from requirements and feature decisions through AWS setup and deployment using AI-assisted development. Includes memory submissions, approval workflows, role-based access, and asynchronous image processing.</p><Link className="case-link" to="/case-studies/remembering-young-hoon">Read case study <span>↗</span></Link></div>
        <div className="tags"><span>Next.js</span><span>AWS</span><span>Data privacy</span><span>AI-assisted delivery</span></div>
      </article>
    </div>
